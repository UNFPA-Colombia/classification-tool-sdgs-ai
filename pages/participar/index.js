...
export default function Participar() {
    ...
    function showButton() {
        if (nombre.length > 2) {
            return (
                <Link href={`/participar/${nombre}`}><button className={styles.buttonStart} role="button">Empezar</button></Link>
            );
        }
    }
            ...
            <div className={styles.main}>
                ...
                <div className={styles.item}>
                    <div className={styles.formGroup}>
                        <input type="input" className={styles.formField} placeholder="Name" name="name" maxLength="20" value={nombre} onChange={handleInputChange} required />
