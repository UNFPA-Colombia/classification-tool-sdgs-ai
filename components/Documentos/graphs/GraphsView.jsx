...
const paiDescription="Esta es una gráfica de torta donde puedes ver la distribución de los tópicos en todos los textos. Ejemplo: En los textos que subiste, se habla en un 15% del tópico 1"
function GraphsView({ coherencia, distribuciones, topicos, files }) {
  ...
  return (
    <div>
      ...
      <GraphComponent title="Distribución de los tópicos en el documento" description={paiDescription} description2={"Si el tópico no se ve, es porque su importancia en el texto es muy pequeña"} derecha={false} data={data} files={files}/>
